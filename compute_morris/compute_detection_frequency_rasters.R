...
compute_fuzzy_cwp(
  results_dir = "../morris_screening_obemme/results",
  ...
  output_path = "detection_frequency_obemme.tif"
)

compute_fuzzy_cwp(
  results_dir = "../morris_screening_emme_v2/results",
  tir_path    = "../data/original_data/thermal_rasters_FINAL/mean_v2emme.tif",
  binary_dir  = "./binary_rasters_emme_v2",
  vrt_path    = "stacked_raster_emme_v2.vrt",
  output_path = "detection_frequency_emme_v2.tif"
)
...
compute_fuzzy_cwp(
  ...
  output_path = "detection_frequency_emme_v1.tif"
)