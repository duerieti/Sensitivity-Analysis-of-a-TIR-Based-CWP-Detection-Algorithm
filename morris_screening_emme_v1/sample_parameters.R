...
morrisDesign <- morris(
    ...
    factors = c("buffer_px", "slab_halfwidth_m"), # the two parameters subjectto variation
    r       = 66, # 66 trajectories in sampling (the optimized sampling strategy for morris deploys trajectories)
