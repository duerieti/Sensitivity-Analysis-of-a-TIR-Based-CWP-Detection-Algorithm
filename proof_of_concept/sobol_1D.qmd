...
-- The terra memory adjustment has not really worked, it still crashed at the same location. I improved rm() gc() now. If this won't work, then I am going to move to the HPC.